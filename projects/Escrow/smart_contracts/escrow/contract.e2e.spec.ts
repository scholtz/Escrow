...
describe('Escrow contract', () => {
  ...
  test('when defined taker withdrawal works to his address - ASA token', async () => {
    // fund contract
    // call claim with correct secret
    // expect transfer and locked state to be cleared
  ...
  test('when defined taker, withdrawal can be executed by others but taker receive funds - ASA token', async () => {
    // fund contract
    // call claim with correct secret
    // expect transfer and locked state to be cleared
