 ...
 */
export function EscrowInstanceFromTuple(abiTuple: [bigint, bigint, bigint, bigint, string, Uint8Array]) {
...
export type EscrowArgs = {
   ...
   */
  obj: {
    'create(txn,uint64,byte[32])void': {
      /**
    ...
    'getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])': {
      secretHash: Uint8Array
    }
   ...
   */
  tuple: {
    'create(txn,uint64,byte[32])void': [txnDeposit: AppMethodCallTransactionArgument, rescueDelay: bigint | number, secretHash: Uint8Array]
    'makeHash(byte[])byte[]': [secret: Uint8Array]
    'getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])': [secretHash: Uint8Array]
...
export type EscrowReturns = {
  'create(txn,uint64,byte[32])void': void
  'makeHash(byte[])byte[]': Uint8Array
  'getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])': EscrowInstance
...
export type EscrowTypes = {
   ...
   */
  methods:
    & Record<'create(txn,uint64,byte[32])void' | 'create', {
      argsObj: EscrowArgs['obj']['create(txn,uint64,byte[32])void']
      argsTuple: EscrowArgs['tuple']['create(txn,uint64,byte[32])void']
      returns: EscrowReturns['create(txn,uint64,byte[32])void']
    }>
    ...
    & Record<'getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])' | 'getEscrow', {
      argsObj: EscrowArgs['obj']['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])']
      argsTuple: EscrowArgs['tuple']['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])']
      returns: EscrowReturns['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])']
    }>
    ...
    & Record<'optInToASA(pay,uint64)void' | 'optInToASA', {
      argsObj: EscrowArgs['obj']['optInToASA(pay,uint64)void']
      argsTuple: EscrowArgs['tuple']['optInToASA(pay,uint64)void']
      returns: EscrowReturns['optInToASA(pay,uint64)void']
    }>
...
export abstract class EscrowParamsFactory {
  /**
   * Constructs a no op call for the create(txn,uint64,byte[32])void ABI method
   *
   ...
   */
  static create(params: CallParams<EscrowArgs['obj']['create(txn,uint64,byte[32])void'] | EscrowArgs['tuple']['create(txn,uint64,byte[32])void']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
      method: 'create(txn,uint64,byte[32])void' as const,
      args: Array.isArray(params.args) ? params.args : [params.args.txnDeposit, params.args.rescueDelay, params.args.secretHash],
    }
  }
  /**
  ...
  /**
   * Constructs a no op call for the getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32]) ABI method
   *
   ...
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static getEscrow(params: CallParams<EscrowArgs['obj']['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])'] | EscrowArgs['tuple']['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
      method: 'getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])' as const,
   ...
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static optInToAsa(params: CallParams<EscrowArgs['obj']['optInToASA(pay,uint64)void'] | EscrowArgs['tuple']['optInToASA(pay,uint64)void']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
...
export class EscrowClient {
  ...
  readonly params = {
    ...
    /**
     * Makes a call to the Escrow smart contract using the `create(txn,uint64,byte[32])void` ABI method.
     *
     * Creates the escrow. The deposit tx funds the escrow and creates HTLC to release the funds with password any time (withdraw method). After the time anyone can call cancel method.
     *
     ...
     */
    create: (params: CallParams<EscrowArgs['obj']['create(txn,uint64,byte[32])void'] | EscrowArgs['tuple']['create(txn,uint64,byte[32])void']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
    ...
    /**
     * Makes a call to the Escrow smart contract using the `getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])` ABI method.
     * 
     * This method is a readonly method; calling it with onComplete of NoOp will result in a simulated transaction rather than a real transaction.
     *
     * EscrowInstance by secret
     ...
     * @returns The call params
     */
    getEscrow: (params: CallParams<EscrowArgs['obj']['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])'] | EscrowArgs['tuple']['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
    ...
    /**
     * Makes a call to the Escrow smart contract using the `optInToASA(pay,uint64)void` ABI method.
     *
     * Anyone can optin this contract to his ASA if he deposits MBR
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    optInToAsa: (params: CallParams<EscrowArgs['obj']['optInToASA(pay,uint64)void'] | EscrowArgs['tuple']['optInToASA(pay,uint64)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.params.call(EscrowParamsFactory.optInToAsa(params))
    },
  ...
  readonly createTransaction = {
     ...
     */
    optInToAsa: (params: CallParams<EscrowArgs['obj']['optInToASA(pay,uint64)void'] | EscrowArgs['tuple']['optInToASA(pay,uint64)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.createTransaction.call(EscrowParamsFactory.optInToAsa(params))
    },
  ...
  readonly send = {
     ...
     */
    create: async (params: CallParams<EscrowArgs['obj']['create(txn,uint64,byte[32])void'] | EscrowArgs['tuple']['create(txn,uint64,byte[32])void']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(EscrowParamsFactory.create(params))
      return {...result, return: result.return as unknown as (undefined | EscrowReturns['create(txn,uint64,byte[32])void'])}
    },
     ...
     * @returns The call result
     */
    getEscrow: async (params: CallParams<EscrowArgs['obj']['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])'] | EscrowArgs['tuple']['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(EscrowParamsFactory.getEscrow(params))
      return {...result, return: result.return as unknown as (undefined | EscrowReturns['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])'])}
    },
     ...
     * @returns The call result
     */
    optInToAsa: async (params: CallParams<EscrowArgs['obj']['optInToASA(pay,uint64)void'] | EscrowArgs['tuple']['optInToASA(pay,uint64)void']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(EscrowParamsFactory.optInToAsa(params))
      return {...result, return: result.return as unknown as (undefined | EscrowReturns['optInToASA(pay,uint64)void'])}
    },
  ...
  /**
   * Makes a readonly (simulated) call to the Escrow smart contract using the `getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])` ABI method.
   * 
   * This method is a readonly method; calling it with onComplete of NoOp will result in a simulated transaction rather than a real transaction.
   *
   * EscrowInstance by secret
   ...
   * @returns The call result
   */
  async getEscrow(params: CallParams<EscrowArgs['obj']['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])'] | EscrowArgs['tuple']['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])']>) {
    const result = await this.appClient.send.call(EscrowParamsFactory.getEscrow(params))
    return result.return as unknown as EscrowReturns['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])']
  }
  ...
  public newGroup(): EscrowComposer {
    ...
    return {
      /**
       * Add a create(txn,uint64,byte[32])void method call against the Escrow contract
       */
      create(params: CallParams<EscrowArgs['obj']['create(txn,uint64,byte[32])void'] | EscrowArgs['tuple']['create(txn,uint64,byte[32])void']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
      ...
      /**
       * Add a getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32]) method call against the Escrow contract
       */
      getEscrow(params: CallParams<EscrowArgs['obj']['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])'] | EscrowArgs['tuple']['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.getEscrow(params)))
        resultMappers.push((v) => client.decodeReturnValue('getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])', v))
        return this
      },
      /**
      ...
      /**
       * Add a optInToASA(pay,uint64)void method call against the Escrow contract
       */
      optInToAsa(params: CallParams<EscrowArgs['obj']['optInToASA(pay,uint64)void'] | EscrowArgs['tuple']['optInToASA(pay,uint64)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
...
export type EscrowComposer<TReturns extends [...any[]] = []> = {
  /**
   * Calls the create(txn,uint64,byte[32])void ABI method.
   *
   * Creates the escrow. The deposit tx funds the escrow and creates HTLC to release the funds with password any time (withdraw method). After the time anyone can call cancel method.
   *
   ...
   */
  create(params?: CallParams<EscrowArgs['obj']['create(txn,uint64,byte[32])void'] | EscrowArgs['tuple']['create(txn,uint64,byte[32])void']>): EscrowComposer<[...TReturns, EscrowReturns['create(txn,uint64,byte[32])void'] | undefined]>
  ...
  /**
   * Calls the getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32]) ABI method.
   *
   * EscrowInstance by secret
   *
   * @param args The arguments for the contract call
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  getEscrow(params?: CallParams<EscrowArgs['obj']['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])'] | EscrowArgs['tuple']['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])']>): EscrowComposer<[...TReturns, EscrowReturns['getEscrow(byte[32])(uint64,uint64,uint64,uint64,address,byte[32])'] | undefined]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  optInToAsa(params?: CallParams<EscrowArgs['obj']['optInToASA(pay,uint64)void'] | EscrowArgs['tuple']['optInToASA(pay,uint64)void']>): EscrowComposer<[...TReturns, EscrowReturns['optInToASA(pay,uint64)void'] | undefined]>
